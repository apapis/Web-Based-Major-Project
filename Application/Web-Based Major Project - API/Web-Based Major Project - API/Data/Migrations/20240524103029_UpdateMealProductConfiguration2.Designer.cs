...
namespace Web_Based_Major_Project___API.Data.Migrations
{
    ...
    [Migration("20240524103029_UpdateMealProductConfiguration2")]
    partial class UpdateMealProductConfiguration2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Based_Major_Project___API.Entities.Allergen", b =>
                {
                    b.HasOne("Web_Based_Major_Project___API.Entities.MealAllergens", "MealAllergens")
                        .WithMany("Allergens")
            ...
            modelBuilder.Entity("Web_Based_Major_Project___API.Entities.MealAllergens", b =>
                {
                    b.HasOne("Web_Based_Major_Project___API.Entities.Meal", null)
                        .WithOne("Allergens")
                        .HasForeignKey("Web_Based_Major_Project___API.Entities.MealAllergens", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
